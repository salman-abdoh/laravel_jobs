    ...
    <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
      ...
      <div class="slid1 carousel-inner">
        <div class="carousel-item active">
          <svg style="background-image: url(img/pexels-pixabay-327540.jpg); background-size:cover;" class="bd-placeholder-img bd-placeholder-img-lg d-block w-100" width="80%" height="400" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: الشريحة الأولى" preserveAspectRatio="xMidYMid slice" focusable="false">
        ...
        <div class=" slid3 carousel-item">
          <svg style="background-image: url(img/pexels-pixabay-356043.jpg); background-size:cover;" class="bd-placeholder-img bd-placeholder-img-lg d-block w-100" width="800" height="400" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: الشريحة الثالثة" preserveAspectRatio="xMidYMid slice" focusable="false">
            <div class="contaier buttm mb-2 ">
...
<!--end slides-->
  <!--اعلانات-->
  <div class=" ads container my-7">
    <h1 class="headerh text-center mb-3 mt-8" style="    margin-top: 17px;"> مساحة اعلانية</h1>
    <hr>
    <div class="row row-rows-1 row-cols-sm-2  row-cols-lg-3 ">
      <div class="col-12" id="road">
        <div class="card shadow-sm p-1 h-140">
          <div class="d-flex  align-items-center flex-direction-center text-center">
            <img src="img/pexels-anamul-rezwan-1216544.jpg" width="200px" height="auto">
    ...
    <div class="album mt-2 pt-5 bg-light text-end">
      <div class="container">

        <h1 class="headerh text-center mb-3 ">الوظائف الحالية</h1>
        <hr>
        <div class="row row-cols-1 row-cols-md-3 row-cols-xs-2 row-cols-sm-2 row-cols-lg-3    g-3">
          ...
          <div class="col" id="web">
            <div class="card shadow-sm p-1 h-140">
              ...
              <div class="d-flex  align-items-center">
                ...
                <div class="card-body">
                  <span class="text-warning">لدي شركة ويب </span>
      ...
      <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 g-4 py-5">
        ...
        <div class="col-lg-2 d-flex" style="    flex-direction: column;
        align-items: center;">
         <div class="border-radius" ><img src="./img/pngegg.png " height="100px" width="100px" alt="" style=" height: 100px;   border-radius: 50%">
         </div>
         <h4 class="pt-2"> بووت ستراب</h2>
        ...
        align-items: center;">
         ...
         <h4 class="pt-2"> رواد</h2>
        </div>
        <div class="col-lg-2 d-flex" style="    flex-direction: column;
        align-items: center;">
         <div class="border-radius" ><img src="./img/pngegg (1).png " height="100px" width="100px" alt="" style=" height: 100px;   border-radius: 50%">
         </div>
   
         <h4 class="pt-2"> جي كويري</h2>
        </div>
        <div class="col-lg-2 d-flex" style="    flex-direction: column;
        align-items: center;">
         <div class="border-radius" ><img src="./img/pngegg (4).png" height="100px" width="100px" alt="" style=" height: 100px;   border-radius: 50%">
