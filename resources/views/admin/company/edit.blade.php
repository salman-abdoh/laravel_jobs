                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        ...
                        <div class="card mb-12">
                            ...
                            @endif
                            <form class="card-body" action="/dashboard/company/{{$data->id}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('PATCH')
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <input name="address" value="{{$data->address}}" type="text" id="multicol-username" class="form-control" placeholder="john.doe" />
